...
-- Watermark Col : UPDATED_AT (used for incremental load)
-- Source System : Aerospace Parts Inventory
-- Load Strategy : Incremental via UPDATED_AT; full load on first run